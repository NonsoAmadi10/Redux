...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _store_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./store/store */ \"./src/store/store.js\");\n/* harmony import */ var _actions_action__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actions/action */ \"./src/actions/action.js\");\n\n // ------ HTML references ------\n\nvar notesUList = document.getElementById(\"notes\");\nvar addNoteForm = document.getElementById(\"add-note\"); // ------ Redux ------\n\nfunction deleteNote(index) {\n  _store_store__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dispatch(Object(_actions_action__WEBPACK_IMPORTED_MODULE_1__[\"delNote\"])(index));\n}\n\nfunction renderNotes() {\n  var notes = _store_store__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getState().notes;\n  console.log(notes);\n  notesUList.innerHTML = \"\";\n  notes.map(function (note, index) {\n    var noteItem = \"\\n      <li>\\n        <b>\".concat(note.title, \"</b>\\n        <button data-id=\\\"\").concat(index, \"\\\">x</button>\\n        <br />\\n        <span>\").concat(note.content, \"</span>\\n      </li>\\n    \");\n    notesUList.innerHTML += noteItem;\n  });\n  setDeleteNoteButtonsEventListeners();\n} // ------ Event Listeners ------\n\n\naddNoteForm.addEventListener(\"submit\", function (e) {\n  e.preventDefault();\n  var title = addNoteForm.title.value;\n  var content = addNoteForm.content.value;\n  _store_store__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dispatch(Object(_actions_action__WEBPACK_IMPORTED_MODULE_1__[\"addNote\"])(title, content));\n});\n\nfunction setDeleteNoteButtonsEventListeners() {\n  var buttons = document.querySelectorAll(\"ul#notes li button\");\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    var _loop = function _loop() {\n      var button = _step.value;\n      button.addEventListener(\"click\", function () {\n        deleteNote(button.dataset.id);\n      });\n    };\n\n    for (var _iterator = buttons[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      _loop();\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n        _iterator[\"return\"]();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n}\n\n_store_store__WEBPACK_IMPORTED_MODULE_0__[\"default\"].subscribe(function () {\n  renderNotes();\n}); // ------ Render the initial Notes ------\n\nrenderNotes();\n\n//# sourceURL=webpack:///./src/index.js?");

/***/ }),

/***/ "./src/reducers/notesReducers.js":
/*!***************************************!*\
  !*** ./src/reducers/notesReducers.js ***!
  \***************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _actions_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/action */ \"./src/actions/action.js\");\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\n\n\nvar notesReducer = function notesReducer() {\n  var notes = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n  var action = arguments.length > 1 ? arguments[1] : undefined;\n\n  switch (action.type) {\n    case _actions_action__WEBPACK_IMPORTED_MODULE_0__[\"ADD_NOTE\"]:\n      return [].concat(_toConsumableArray(notes), [{\n        title: action.title,\n        content: action.content\n      }]);\n\n    case _actions_action__WEBPACK_IMPORTED_MODULE_0__[\"REMOVE_NOTE\"]:\n      return notes.filter(function (note, index) {\n        return index != action.id;\n      });\n\n    default:\n      return notes;\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (notesReducer);\n\n//# sourceURL=webpack:///./src/reducers/notesReducers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _notesReducers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notesReducers */ \"./src/reducers/notesReducers.js\");\n/* harmony import */ var _visibilityFilter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./visibilityFilter */ \"./src/reducers/visibilityFilter.js\");\n/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! redux */ \"./node_modules/redux/es/redux.js\");\n\n\n\nvar reducers = Object(redux__WEBPACK_IMPORTED_MODULE_2__[\"combineReducers\"])({\n  notes: _notesReducers__WEBPACK_IMPORTED_MODULE_0__[\"default\"],\n  visibilityFilter: _visibilityFilter__WEBPACK_IMPORTED_MODULE_1__[\"default\"]\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (reducers);\n\n//# sourceURL=webpack:///./src/reducers/rootReducer.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _actions_action__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/action */ \"./src/actions/action.js\");\n\n\nfunction visibilityFilter() {\n  var visibility = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _actions_action__WEBPACK_IMPORTED_MODULE_0__[\"SHOW_ALL\"];\n  var action = arguments.length > 1 ? arguments[1] : undefined;\n\n  switch (action.type) {\n    case _actions_action__WEBPACK_IMPORTED_MODULE_0__[\"SHOW_ALL\"]:\n      return _actions_action__WEBPACK_IMPORTED_MODULE_0__[\"SHOW_ALL\"];\n\n    default:\n      return visibility;\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (visibilityFilter);\n\n//# sourceURL=webpack:///./src/reducers/visibilityFilter.js?");
